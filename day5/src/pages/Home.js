    ...
    <>
      ...
      {contextHolder}
        ...
        <div className="mainDiv">
          <div className="innerTop">
            <h2>Products</h2>
            <Button variant="contained" style={{ display: add }} onClick={itemVis}>Add Item</Button>
            <Button variant="contained" style={{ display: cart }} onClick={cartVis}>Cart</Button>
          </div>
          <div style={{ display: "flex", flexWrap: "wrap" }}>
...

            {
              ...
              items.length === 0 ?
                <div style={{ margin: "auto", textAlign: "center" }}><img src={empty} height={100} style={{ margin: "auto", marginTop: "calc(100vh - 600px)", boxShadow: "0px 70px 80px -25px gray" }} />
                  <p>No Product</p>
                </div>
                :
                items.map((e, indx) => {
                  return <Item itemT={e.t} itemP={e.p} image={e.i} item={cart} red={add} index={index} itemIndex={indx} call={call} />
                })
        ...
        <div className="popupBox">
          ...
          <div style={{ textAlign: "center", marginTop: 30 }}>
            ...
            >
              ...
              >
                <Input onChange={updateUN} prefix={<UserOutlined className="site-form-item-icon" />} placeholder="Username" />
              </Form.Item>
              <Form.Item
                name="password"
                rules={[{ required: true, message: 'Please input your Password!' }]}
              >
                <Input onChange={updatePass}
      ...
      <div className="popupBackground" style={{ display: item }}>
        <div className="popupBox">
          ...
          <div style={{ textAlign: "center", marginTop: 30 }}>
            ...
            <img src={image} height={150} width={150} style={{ backgroundColor: "#F0F0F0" }} /><br />
            <input type="file" style={{ marginBottom: 30 }} onChange={handleImageUpload} />
            ...
            >
              ...
              <Form.Item>
                <Button type="primary" onClick={addProduct} style={{ backgroundColor: "rgb(83, 143, 255)", color: "white" }} htmlType="submit" className="login-form-button">
                  add
                </Button>
      ...
      <div className="popupBackground" style={{ display: showcart }}>
        <div className="popupBox" style={{ width: "50%" }}>
          <div className="popupTop">
            <h3 style={{ display: "flex" }}>Cart Items<div className="count" >{cartItems.length}</div></h3>
            <div className="exit" onClick={cartHide}></div>
          </div>
          <div style={{ textAlign: "center", marginTop: 30, width: "100%", display: "flex", overflow: "scroll" }}>

            {
              cartItems.length === 0 ?
                <div style={{ margin: "auto", textAlign: "center" }}><img src={empty} height={70} style={{ margin: "auto", boxShadow: "0px 70px 80px -25px gray" }} />
                  <p style={{ marginBottom: 60 }}>No Items</p>
                </div>
                :
                cartItems.map((e,indx) => {
                  return <Item itemT={e.t} itemP={e.p} image={e.i} item={"none"} red={"none"} index={index} itemIndex={indx}/>
                })
            }
      ...
      <div className="profile" style={{ display: profileVis }}>
        ...
        <Button variant="outlined" onClick={callFunctions} style={{ marginTop: 15, marginRight: 15 }}>Edit</Button>
        <Button variant="outlined" color="error" onClick={logOut} style={{ marginTop: 15 }}>
          Logout
        </Button>
      </div>
    </>
