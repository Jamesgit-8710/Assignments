...
function Item({ itemT, itemP, image, item, red, index, itemIndex, call }) {
    ...
    return (
        <Card
            ...
            cover={<img alt="example" height={150} src={image} style={{ objectFit: "contain" }} />}
        >
            <Meta title={"Product : " + itemT} description={"Price : " + itemP} style={{ fontSize: "1rem", marginBottom: 10 }} />
            <Button variant="contained" style={{ margin: "auto", display: item }} onClick={add}>Add to cart</Button>
            <Button variant="contained" style={{ margin: "auto", display: red, backgroundColor: "red" }} onClick={del}>Delete</Button>
        </Card>
    )
}
